...
const group = categoryGroups.find((g) => g.slug === "accessories")!;
        ...
        <div className="container" style={{ position: "relative", zIndex: 2, padding: "var(--space-20) var(--space-4)" }}>
          ...
          >
            ...
            >
              ...
              {t("accessories.backToCategories")}
            </Link>
          </motion.div>
        </div>
      </section>
          ...
          <div className="container">
            <div className="section-header">
              <span className="section-badge">
                ...
                {t("accessories.featured")}
              </span>
              <h2>{t("accessories.featuredProduct")}</h2>
            </div>
                  ...
                  <div style={{ padding: "var(--space-8)", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "var(--space-2)", marginBottom: "var(--space-4)" }}>
                      ...
                      <span style={{ fontSize: "var(--text-xs)", color: "var(--c-gray-400)" }}>
                        ({featured.reviewCount} {t("accessories.reviews")})
                      </span>
                    </div>
        ...
        <div className="container">
          <div className="section-header">
            <span className="section-badge">
              ...
              {t("accessories.allProducts")}
            </span>
            <h2>{t("accessories.accessoriesProducts")}</h2>
          </div>
          ...
          {filteredProducts.length === 0 && (
            <div className="empty-state">
              ...
              <h4 className="empty-state-title">{t("accessories.noProducts")}</h4>
              <p className="empty-state-desc">{t("accessories.noProductsDesc")}</p>
            </div>
          )}
        </div>
      </section>
          ...
          <div className="container">
            <div className="section-header">
              <span className="section-badge">
                ...
                {t("accessories.bestSellers")}
              </span>
              <h2>{t("accessories.bestSellersTitle")}</h2>
            </div>
          ...
          <div className="container">
            <div className="section-header">
              <span className="section-badge">
                ...
                {t("accessories.newArrivals")}
              </span>
              <h2>{t("accessories.newArrivalsTitle")}</h2>
            </div>
